...
SCAM_TRIGGERS = [
    # คำเดิม: ใช้ส่งให้ LLM เมื่อคะแนนผ่านเกณฑ์ ไม่ได้ยืนยันว่าเป็น Scam
    "อนุมัติ", "ดอกเบี้ย", "กู้", "รับเงิน", "รายได้", "โอนมัดจำ",
    "ลิงก์", "เครดิต", "พัสดุ", "คลิก", "ภารกิจ", "ออเดอร์", "แอดไลน์", "ดาวน์",
    # การลงทุน: ให้ AI แยกคำชักชวนออกจากข่าว/การศึกษาอีกที
    "ลงทุน", "รับประกันกำไร", "ไม่มีความเสี่ยง",
    # การแอบอ้างเจ้าหน้าที่: ให้ AI อ่านบริบท ไม่เตือนจากคำว่า "ตำรวจ" อย่างเดียว
    "ตำรวจ", "ฟอกเงิน", "บัญชีตรวจสอบ", "ห้ามแจ้งครอบครัว",
]
